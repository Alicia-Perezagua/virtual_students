...
<div id="accordion">
    <div class="card">
        ...
        <h5 class="mb-0">
            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#contenedor-unidades" aria-expanded="false" aria-controls="contenedor-unidades">
            Collapsible Group Item #1
            </button>
        </h5>
        </div>
        
        <div id="contenedor-unidades" class="collapse" aria-labelledby="headingOne2">
